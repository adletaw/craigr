...
pre-programmed three-letter coes in Craigslist.  For example, using `see`
limits the search to the Seattle city limits only.

```{r location, message = FALSE, cache = TRUE}
